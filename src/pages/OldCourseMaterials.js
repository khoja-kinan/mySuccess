...
import OldCourseMaerialsMoreMenu from "../sections/@dashboard/user/courses/OldCourseMaerialsMoreMenu";
//------------------------------------------------------------------
...
export default function OldCourseMaterials() {
  ...
  useEffect(() => {
    function fecthData() {
      if (token === null) {
        ...
        axios
          .get(`${CourseVideoUnitsURL}${courseId}/previous/materialUnits`, {
            headers: {
  ...
  const handleSubmitAddUnit = () => {
    ...
    axios
      .post(`${CourseVideoUnitsURL}${courseId}/video-units`, data, {
        headers,
      })
      .then((response) => {
        setLoadingBtn(false);
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell
                            align={i18n.dir() === "ltr" ? "left" : "right"}
                          >
                            <Link to="/dashboard/unit/materials" state={row}>
                              <Iconify
                                icon="bi:eye-fill"
                                width={20}
                                height={20}
