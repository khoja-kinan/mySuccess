...
export default function CoursesLessons({
  user,
  token,
  setLoadingBtn,
  loadingBtn,
  ...
  return (
    <>
      ...
      >
        <DialogTitle>دروس مادة {user.name}</DialogTitle>
        <DialogContent
          sx={{
            width: "100%",
            height: 120,
        ...
        >
          <Link
            to={`/dashboard/courses/${user.id}/video-units`}
          ...
          <Link
            to={`/dashboard/courses/${user.id}/folders`}
            style={{ textDecoration: "none" }}
          >
            <Button
              variant="outlined"
